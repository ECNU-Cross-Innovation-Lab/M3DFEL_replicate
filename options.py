...
class Options(object):
    ...
    def initialize(self):
        ...
        parser.add_argument('--gpu_ids', type=str, default='0,1,2,3', help='gpu ids, eg. 0,1,2; -1 for cpu.')
        parser.add_argument('--resume', default=None, type=str, metavar='PATH', help='path to latest checkpoint')
        parser.add_argument('--start_epoch', default=0, type=int, metavar='N', help='manual epoch number (useful on restarts)')
        parser.add_argument('--fold', default='1', type=str)
        parser.add_argument('--seed', default='42', type=int)
        parser.add_argument('--root', default='/dockerdata/', type=str)
        ...
        parser.add_argument('--crop_size', default=112, type=int, metavar='N', help='crop size')
    ...
    def parse(self):
        ...
        if args.dataset == "DFEW":
            args.train_dataset = os.path.join(args.root, "EmoLabel_DataSplit/train(single-labeled)/set_X.csv")
            args.test_dataset = os.path.join(args.root, "EmoLabel_DataSplit/test(single-labeled)/set_X.csv")
        ...
        msg += '--------------------- End ----------------------\n'
        print(msg)
        with open(os.path.join(os.path.join(args.output_path, "opt.txt")), 'a+') as f:
            f.write(msg + '\n\n')
